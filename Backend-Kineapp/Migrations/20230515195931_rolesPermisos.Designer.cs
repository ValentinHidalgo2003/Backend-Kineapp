...
namespace Backend_Kineapp.Migrations
{
    ...
    [Migration("20230515195931_rolesPermisos")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Backend_Kineapp.Modelos.Permiso", b =>
                {
            ...
            modelBuilder.Entity("Backend_Kineapp.Modelos.Rol", b =>
                {
            ...
            modelBuilder.Entity("Backend_Kineapp.Modelos.RolesPermisos", b =>
                {
                    ...
                    b.Property<int?>("IdPermisoNavigation")
                        .HasColumnType("int");

                    b.Property<int>("IdRol")
                        .HasColumnType("int");

                    b.Property<int?>("IdRolNavigation")
                        .HasColumnType("int");

                    b.HasKey("IdRolPermiso");

                    b.HasIndex("IdPermisoNavigation");

                    b.HasIndex("IdRolNavigation");
            ...
            modelBuilder.Entity("Backend_Kineapp.Modelos.RolesPermisos", b =>
                {
                    b.HasOne("Backend_Kineapp.Modelos.Permiso", "IdPermisoNavigation")
                        .WithMany("RolesPermisos")
                        .HasForeignKey("IdPermisoNavigation");

                    b.HasOne("Backend_Kineapp.Modelos.Rol", "IdRolNavigation")
                        .WithMany("RolesPermisos")
                        .HasForeignKey("IdRolNavigation");
